 ...
 */
const Guest_Food_List_UI: React.FC = () => {
  // --------------------- Hooks ---------------------
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 ">
      {/* --------------------- Header --------------------- */}
      <div className="sticky top-0 z-10 bg-gray-50 backdrop-blur-md border-b border-gray-200">
          ...
          <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-6">
            {foodList.map((food) => {
              ...
              return (
                <Link
                  key={food._id}
                  to={`/guest-dashboard/food/order/${food._id}`}
...
export default Guest_Food_List_UI
