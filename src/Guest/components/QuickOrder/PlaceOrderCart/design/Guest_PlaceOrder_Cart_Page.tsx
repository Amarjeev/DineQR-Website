...
const PlaceOrder_Cart_Page: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50">
      {/* Header */}
      <div className=" border-b border-gray-200 sticky top-0 z-10 mt-2">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Orders Button */}
            <button
              onClick={() => navigate('/guest-dashboard/orders')} // navigate to orders page
              className="flex items-center gap-2 px-3 py-2 bg-green-500 hover:bg-green-600 text-white rounded-xl font-medium text-sm sm:text-base"
            >
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        {addedFoodItems.length === 0 ? (
          <div className="text-center py-16">
            <div className=" rounded-2xl p-6 sm:p-8 max-w-sm mx-auto">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs mb-2">
                      Providing your email allows you to receive live
                      notifications and billing/payment updates directly to your
                      inbox.
                    </p>
                    <input
                      type="email"
              ...
              <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6">
                ...
                <div className="max-h-96 overflow-y-auto space-y-4">
                  {addedFoodItems.map((item) => {
                    const itemTotal = item.portions.reduce(
                    ...
                    return (
                      <div
                        key={item.id}
                        className="flex items-start gap-3 p-3 border border-gray-200 rounded-xl hover:border-gray-300"
                      >
                        {/* Image */}
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm font-semibold text-gray-900 mt-1">
                            Item Total:{' '}
                            <span className="text-green-600">₹{itemTotal}</span>
                          </p>
                        </div>
                        ...
                        <div className="flex flex-col gap-1 flex-shrink-0">
                          <Link
                            to={`/guest-dashboard/food/order/${item.id}`}
                            className="flex items-center gap-1 bg-blue-500 text-white px-2 py-1 rounded-lg text-xs sm:text-sm hover:bg-blue-600"
                          >
                            <Edit3 className="w-3 h-3" /> Edit
                          </Link>
                          <button
                            onClick={() => handleCancelItem(item.id)}
                            className="flex items-center gap-1 bg-red-500 text-white px-2 py-1 rounded-lg text-xs sm:text-sm hover:bg-red-600"
                          >
            ...
            <div className="lg:w-80">
              <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 sticky top-20">
                ...
                <button
                  ...
                  onClick={() => handleConfirmOrder('guest')}
                ...
                <div className="mt-4 text-center text-xs text-gray-500">
                  You'll pay ₹{totalAmount} at the counter
                </div>
              </div>
            </div>
          </div>
...
export default PlaceOrder_Cart_Page
