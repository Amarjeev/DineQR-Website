                    ...
                    return (
                      <div key={item.id} className="flex items-start gap-3 p-3 border border-gray-200 rounded-xl hover:border-gray-300">
                        ...
                        <div className="flex flex-col gap-1 flex-shrink-0">
                          <Link to={`/staff-dashboard/food/order/${item.id}`} className="flex items-center gap-1 bg-blue-500 text-white px-2 py-1 rounded-lg text-xs sm:text-sm hover:bg-blue-600">
            ...
            <div className="lg:w-80">
              <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 sticky top-20">
                ...
                <button
                  ...
                  onClick={() => handleConfirmOrder('staff')}
...
export default Staff_PlaceOrder_Cart_Page
