...
const Staff_Food_Detail_Page: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Header */}
      <div className="sticky top-0 z-10 bg-white/80 backdrop-blur-md border-b border-gray-200 lg:bg-transparent lg:backdrop-blur-none lg:border-none">
        <div className="max-w-7xl mx-auto px-4 py-3 lg:px-6 lg:py-6">
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 p-3 rounded-2xl bg-white shadow-sm hover:shadow-md transition-all duration-200 border border-gray-200 hover:border-gray-300 text-gray-700 hover:text-gray-900 group lg:bg-white/90 lg:backdrop-blur-sm"
          >
...
export default Staff_Food_Detail_Page
